Shader "Unity Shader Books/EmissiveSmoke"
{
    Properties
    {
        _Color ("Color", Color) = (1,1,1,1)
        _MainTex ("Albedo (RGBA)", 2D) = "white" {}
        [HDR] _EmissionColor("Emissive Color",Color)=(1,0,0,1)
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            float distanceFromEmission=clamp(_EmissionRange-length(IN.worldPos.xyz-_EmissionLocation.xyz),0,1)/_EmissionRange;
